...
const Shopcar: React.FC = () => {
  ...
  const { cartItems, removeFromCart, updateCartItemQuantity, clearCart } = useAppStore()
                  ...
                  <div className='flex gap-6'>
                    ...
                    <div className='flex-1'>
                      <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                        {/* 商品属性 */}
                        <div>
                          <h3 className='font-semibold text-gray-900 mb-2'>商品属性</h3>
                        ...
                        <div>
                          <div className='space-y-4'>
                            <div>
                              <span className='font-medium text-gray-900'>单价：</span>
                            ...
                            <div>
                              <span className='font-medium text-gray-900'>小计：</span>
                              <span className='text-red-600 font-semibold'>
            ...
            <div className='flex justify-between items-center'>
              <div>
                <div className='text-lg text-gray-600'>
                  总计：<span className='text-2xl font-bold text-red-600'>
