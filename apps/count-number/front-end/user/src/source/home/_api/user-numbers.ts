...
export const getNumbersRequest = async (): Promise<NumberItem[]> => {
  try {
    ...
    if (res.data.success && res.data.data) {
      ...
      throw new Error(res.data.error || '获取数据失败：业务错误')
    }
  } catch (error: any) {
...
export const createNumberRequest = async (
  ...
  try {
    ...
    if (res.data.success && res.data.data) {
      ...
      throw new Error(res.data.error || '创建数据失败：业务错误')
    }
  } catch (error: any) {
...
export const updateNumberRequest = async (
  ...
  try {
    ...
    if (res.data.success && res.data.data) {
      ...
      throw new Error(res.data.error || '更新数据失败：业务错误')
    }
  } catch (error: any) {
...
export const deleteNumberRequest = async (
  ...
  try {
    ...
    if (res.data.success && res.data.data) {
      ...
      throw new Error(res.data.error || '删除数据失败：业务错误')
    }
  } catch (error: any) {
